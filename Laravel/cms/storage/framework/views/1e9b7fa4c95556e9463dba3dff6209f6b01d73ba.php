...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/mobile.css')); ?>">
	<script src="<?php echo e(URL::asset('js/mobile.js')); ?>" type="text/javascript"></script>
</head>
<body>
	<div id="page">
		<div id="header">
			<div>
				<a href="index.html" class="logo"><img src="<?php echo e(URL::asset('images/logo.png')); ?>" alt=""></a>
				<ul id="navigation">
					<li class="selected">
		...
		<div id="body" class="home">
			<div class="header">
				<img src="<?php echo e(URL::asset('images/bg-home.jpg')); ?>" alt="">
				<div>
			...
			<div class="body">
				<div>
					...
					<img src="<?php echo e(URL::asset('images/yogurt.jpg')); ?>" alt="">
				</div>
			</div>
			<div class="footer">
				<div>
